...
$testClientId = 'AcH9OlDvwD4g5S7fE4U1m-7tee_CiC6mPH_fxFKzgbiknxg8fTt9xH-VjKNuiLwXhDVg5mLmFx_wKhlS';
$testClientSecret = 'ECucZFofNjTKFaTBKqaFHLJxwTGtLfm9dP-s5LIE64IVVNucnwX9qqhfbc6ILyGcI0-WZFJhriThIBtL';

$liveClientId = 'AbQ6qNiZGyARxRd7fdzxYAQv2n-S4fOd_zUJNvPV9TwgyamXj7Fe-616wRbTIOlbrWf804AQmPnO2C1N';
$liveClientSecret = 'ELmHPLvIY5DDnUYIOgkSXHGOvGI3cYmkW-JTaylYemR8RT9Dg2WYlCegeleClZrz3MvL7cARXMNAh2Rm';
return [
    'class' => 'kongoon\yii2\paypal\Paypal',
    'clientId' => YII_DEBUG ? $testClientId : $liveClientId,
    'clientSecret' => YII_DEBUG ? $testClientSecret : $liveClientSecret,
    ...
    'currency' => 'USD',
    'isProduction' => YII_DEBUG ? false : true,
    // This is config file for the PayPal system
    'config' => [
        'http.ConnectionTimeOut' => 60, //script timeout in seconds
        'http.Retry' => 2, //retry only once
        'mode' => YII_DEBUG ? \kongoon\yii2\paypal\Paypal::MODE_SANDBOX : \kongoon\yii2\paypal\Paypal::MODE_LIVE,    // sandbox | live
