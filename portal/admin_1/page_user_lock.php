        ...
        <div class="page-lock">
            <div class="page-logo">
                <a class="brand" href="index.html">
                    <img src="http://www.eoction.com/eoction-logo.png" alt="logo" style="height:15px;" /> </a>
            </div>
            <div class="page-body">
                <img class="page-lock-img" src="../assets/pages/media/profile/profile.jpg" alt="">
                <div class="page-lock-info">
                    <h1>John Doe</h1>
                    <span class="email"> john@eoction.com </span>
                    ...
                    <form class="form-inline" action="index.html">
                        ...
                        <!-- /input-group -->
                        <div class="relogin">
                            <a href="page_user_login.php"> Not John Doe ? </a>
                        </div>
                    </form>
                </div>
            </div>
            <div class="page-footer-custom"> 2016 &copy; EOCTION Merchant Portal. </div>
        </div>
        <!--[if lt IE 9]>
